...
Το πρόγραμμα πίσω απο τον «Διαδραστικό 3D Εκτυπωμένο Χάρτη Προσβασιμότητας», των Ομίλων «STEM, 3D & AI» και «TechArt: Τεχνολογία, Δημιουργία, Καινοτομία» του 4ου Πειραματικού ΓΕΛ Τρικάλων.
...
sequenceDiagram
  ...
  Note over Πρόγραμμα,RPI: Όταν ολοκληρωθεί η <br/> αναπαραγωγή πολυμέσων
  Πρόγραμμα ->> Οθόνη: Αναπαραγωγή IDLE
